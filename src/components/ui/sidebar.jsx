...
const SidebarProvider = React.forwardRef((
  ...
  // internal uncontrolled state when openProp is not provided
  ...
  const setOpen = React.useCallback(
    (value) => {
      ...
      try {
        ...
        // ignore cookie errors (e.g., SSR environments)
      }
    },
    [setOpenProp, open]
  );
...
const SidebarHeader = React.forwardRef(({ className, children, ...props }, ref) => {
  return (
    <header ref={ref} className={cn("flex items-center justify-between px-3 py-2", className)} {...props}>
      {children}
    </header>
  );
});
...
const SidebarFooter = React.forwardRef(({ className, children, ...props }, ref) => {
  return (
    <footer ref={ref} className={cn("px-3 py-2", className)} {...props}>
      {children}
    </footer>
  );
});
...
// simple cva usage for menu button variants
