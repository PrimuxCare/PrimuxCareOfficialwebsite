        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="group bg-emerald-600 text-white px-8 py-4 rounded-lg hover:bg-emerald-700 transition-all hover:scale-105 flex items-center justify-center gap-2 font-semibold">
                Get Started
                <ArrowRight
                  size={20}
              ...
              <button className="group border-2 border-emerald-600 text-emerald-600 px-8 py-4 rounded-lg hover:bg-emerald-50 hover:text-emerald-700 transition-all flex items-center justify-center gap-2 font-semibold">
                <Play
                  size={20}
